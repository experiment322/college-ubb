...
public:
    ...
    QPushButton *contractCRUDGUIButton;
    QPushButton *contractReadOnlyGUIButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        createButton->setGeometry(QRect(10, 510, 161, 31));
        updateButton = new QPushButton(centralWidget);
        updateButton->setObjectName(QStringLiteral("updateButton"));
        updateButton->setGeometry(QRect(170, 510, 161, 31));
        deleteButton = new QPushButton(centralWidget);
        deleteButton->setObjectName(QStringLiteral("deleteButton"));
        deleteButton->setGeometry(QRect(330, 510, 161, 31));
        contractCRUDGUIButton = new QPushButton(centralWidget);
        contractCRUDGUIButton->setObjectName(QStringLiteral("contractCRUDGUIButton"));
        contractCRUDGUIButton->setGeometry(QRect(10, 540, 241, 31));
        contractReadOnlyGUIButton = new QPushButton(centralWidget);
        contractReadOnlyGUIButton->setObjectName(QStringLiteral("contractReadOnlyGUIButton"));
        contractReadOnlyGUIButton->setGeometry(QRect(250, 540, 241, 31));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        contractCRUDGUIButton->setText(QApplication::translate("MainWindow", "Contract CRUD GUI", nullptr));
        contractReadOnlyGUIButton->setText(QApplication::translate("MainWindow", "Contract RO GUI", nullptr));
